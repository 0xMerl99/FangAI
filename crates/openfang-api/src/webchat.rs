...
/// GET /logo.png — Serve the FangAI logo.
...
/// GET /favicon.ico — Serve the FangAI favicon.
...
/// GET / — Serve the FangAI Dashboard single-page application.
///
...
/// The embedded HTML/CSS/JS for the FangAI Dashboard.
///
